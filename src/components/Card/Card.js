...
function Card ({ taskObj, index, updateList, deleteTask }) {
    ...
    return (
        <div className="card-wrapper mb-5">
            ...
            <div className="task-holder">
                <span className="card-header py-2" style={{"backgroundColor": colors[index%5].secondaryColor, "borderRadius": "10px"}}>{taskObj.Name}</span>
                <p className="card-description mx-2">{taskObj.Description}</p>

                <div style={{"position": "absolute", "right": "20px", "bottom": "20px"}}>
                    <i className="me-2" style={{"color" : colors[index%5].primaryColor, "cursor": "pointer"}} onClick={() => setModal(true)}><FaEdit /></i>
